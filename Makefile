...
batch0: pg_bulkload chkpass geoip pg_jobmon logerrors login_hook pg_auth_mon pgpdf topn pg_upless pg_task pg_readme vasco pg_xxhash pg_duration ddl_historization data_historization schedoc #pg_mon pg_timeit
...
.PHONY: rust deps batch1 batch2 deb-collect \
 	...
 	scws libduckdb pgcopydb pg_bulkload libfq pg4ml pgpdf topn pg_upless pg_task pg_readme vasco pg_xxhash pg_duration ddl_historization data_historization schedoc \
