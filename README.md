...
```bash
rust: pg_search pg_lakehouse pgml pg_graphql pg_jsonschema wrappers pg_parquet pgvectorscale plprql pg_idkit pgsmcrypto pgdd pg_tiktoken pg_vectorize pg_later #pg_tier
